...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('/home/eloe/.vscode/extensions/wallabyjs.console-ninja-1.0.430/out/buildHook/index.js').default({tool: 'webpack', checkSum: '20b8d9034bbdd929c25205VxZdAR4DDlcAXQUAVw4BA1EFB1MG', mode: 'build'}); } catch(cjsError) { try { import('file:///home/eloe/.vscode/extensions/wallabyjs.console-ninja-1.0.430/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '20b8d9034bbdd929c25205VxZdAR4DDlcAXQUAVw4BA1EFB1MG', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
