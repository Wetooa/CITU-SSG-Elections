...
/* build-hook-start *//*00001*/try { require('/home/eloe/.vscode/extensions/wallabyjs.console-ninja-1.0.430/out/buildHook/index.js').default({tool: 'nest.js', checkSum: '206f958c1aced9bbc23f31B1cXBRZVC1VWBFYKBANaVgFQAgMP', mode: 'build'}); } catch(cjsError) { try { import('file:///home/eloe/.vscode/extensions/wallabyjs.console-ninja-1.0.430/out/buildHook/index.js').then(m => m.default.default({tool: 'nest.js', checkSum: '206f958c1aced9bbc23f31B1cXBRZVC1VWBFYKBANaVgFQAgMP', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
