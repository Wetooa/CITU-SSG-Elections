...
/* build-hook-start *//*00001*/try { require('/home/eloe/.vscode/extensions/wallabyjs.console-ninja-1.0.430/out/buildHook/index.js').default({tool: 'nest.js', checkSum: '20fc45f9f3c19a80466066V1IaBUgPXAUFBglZClJRVVcBUw8A', mode: 'build'}); } catch(cjsError) { try { import('file:///home/eloe/.vscode/extensions/wallabyjs.console-ninja-1.0.430/out/buildHook/index.js').then(m => m.default.default({tool: 'nest.js', checkSum: '20fc45f9f3c19a80466066V1IaBUgPXAUFBglZClJRVVcBUw8A', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
