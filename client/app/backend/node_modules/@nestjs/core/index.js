"use strict";
/* build-hook-start *//*00001*/try { require('/home/eloe/.vscode/extensions/wallabyjs.console-ninja-1.0.430/out/buildHook/index.js').default({tool: 'nest.js', checkSum: '2094d8d241bad1da162e65CAVKCEoEDgBUUVRTBgVQDwUABFBa', mode: 'runtime'}); } catch(cjsError) { try { import('file:///home/eloe/.vscode/extensions/wallabyjs.console-ninja-1.0.430/out/buildHook/index.js').then(m => m.default.default({tool: 'nest.js', checkSum: '2094d8d241bad1da162e65CAVKCEoEDgBUUVRTBgVQDwUABFBa', mode: 'runtime'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
