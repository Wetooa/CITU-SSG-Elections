...
export const VotesCastRow = ({
  ...
  const bgImageLeftCandidate = PARTYLIST_TO_IMAGE[candidates[0].party_list];
  const bgImageRightCandidate =
    candidatesLength > 1 ? PARTYLIST_TO_IMAGE[candidates[1].party_list] : "";
        ...
        {candidatesLength === 2 && (
          <>
            <div className="flex sm:flex-col flex-row gap-2 items-center my-1 sm:my-0">
              ...
              <span className="text-base sm:text-lg font-semibold text-center px-2 font-sans flex-1">
                vs.
              </span>
              <div className="border-t sm:border-l sm:h-6 w-6 sm:w-auto" />
            </div>
